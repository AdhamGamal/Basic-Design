...
class MoviesAdapterVer(private val movies: List<Movie>, private val activity: ItemListActivity) :
    RecyclerView.Adapter<MoviesAdapterVer.ItemViewHolder>() {

    class ItemViewHolder(private val binding: ListItemVerBinding, activity: ItemListActivity) :
